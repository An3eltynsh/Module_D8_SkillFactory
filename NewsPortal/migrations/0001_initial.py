    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating_a', models.IntegerField(db_column='rating_author', default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('choice', models.CharField(choices=[('A', 'Статья'), ('N', 'Новость')], db_column='Type_post', default='N', max_length=1)),
                ('dtime_p', models.DateTimeField(auto_now_add=True, db_column='datetime_post')),
                ('title', models.CharField(max_length=255)),
                ('text_p', models.TextField(db_column='text_post')),
                ('rating_p', models.IntegerField(db_column='rating_post', default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating_c', models.IntegerField(db_column='rating_comment', default=0)),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='NewsPortal.post')),
